...
class Standard(Base):
    ...
    technical_committee = Column(String(255))
    ics_code = Column(String(30))
    scope = Column(Text)
    description = Column(Text)

    key_requirements = Column(JSON, default=[])
    sections = Column(JSON, default=[])
    applicable_products_or_industries = Column(ARRAY(String), default=[])
    keywords = Column(ARRAY(String), default=[])
    related_standards = Column(JSON, default=[])
    ...
    embedding_id = Column(String(120))
